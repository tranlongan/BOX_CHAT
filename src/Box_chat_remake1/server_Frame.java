...
public class server_Frame extends JFrame {
    ...
    private static JTextArea txaOup1, txaInp1;
    ...
    public server_Frame(int port){
        ...
        txaInp1 = new JTextArea();
        send1 = new JButton(">>");
        inpPanel1.add(txaInp1);
        inpPanel1.add(send1);
    ...
    public static void appendFile(String fileTxt){
        txaOup1.append(fileTxt);
    }
}
